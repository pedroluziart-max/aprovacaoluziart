    ...
    <div className="fixed inset-0 flex flex-col bg-gradient-to-br from-background to-muted overscroll-none">
      <header className="flex-none border-b bg-card/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 sm:py-6 text-center">
          <h1 className="text-xl sm:text-2xl font-bold text-primary break-words">{batch.name}</h1>
      ...
      <main className="flex-1 overflow-auto">
        <div className="container mx-auto max-w-3xl px-2 sm:px-4 py-4 sm:py-8 pb-32">
